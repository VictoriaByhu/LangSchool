...
const reviews = [
  {
    id: 1,
    stars: 5,
    text: 'Розмовний клуб був неймовірним! Я нарешті подолала свій страх розмови. Викладач-носій англійської був фантастичним.',
    author: 'Діана В.',
    course: 'Клуб розмовної англійської'
  },
  {
    id: 2,
    stars: 5,
    text: 'Я пройшов курс англійської A1 як повний новачок. Структура була зрозумілою, а викладач був дуже терплячим. Дуже рекомендую!',
    author: 'Мар\'ян Т.',
    course: 'Англійська - Початковий (A1)'
  },
  {
    id: 3,
    stars: 4,
  ...
  },
  {
    id: 4,
    stars: 5,
    text: 'Курс англійської для рівня А1 був ідеальним. Викладач був захопливим і зробив вивчення граматики цікавим. Я записуюся на рівень А2!',
    author: 'Павло Б.',
    course: 'Англійська - Початковий (A1)'
  },
  {
    id: 5,
    stars: 5,
    text: 'Я нервувала через розмову англійською, але Speaking club — це дуже підтримуюче та веселе середовище. Це справді працює.',
    author: 'Марія Л.',
    course: 'Клуб розмовної англійської'
  },
  {
